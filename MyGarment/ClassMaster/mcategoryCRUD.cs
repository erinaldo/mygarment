    ...
    class mcategoryCRUD
    {
        ...
        public DataSet getData()
        {
            ...
            try
            {
                ...
                strQuery.CommandText = "SELECT CATEGORYID,DESCRIPTION,ACTIVE from tblmcategory";
                MySql.Data.MySqlClient.MySqlDataAdapter data = new MySql.Data.MySqlClient.MySqlDataAdapter(strQuery);
                data.Fill(ds, "tblmcategory");
        ...
        public DataSet getData(string item)
        {
            ...
            try
            {
                ...
                strQuery.Connection = Conn.Conn;
                strQuery.CommandType = CommandType.Text;
                strQuery.CommandText = "SELECT CATEGORYID,DESCRIPTION,ACTIVE FROM tblmcategory WHERE CATEGORYID=@CategoryID";
        ...
        public DataSet getData(string CategoryID,string Description,string Active)
        {
            ...
            try
            {
                ...
                strQuery.Connection = Conn.Conn;
                strQuery.CommandType = CommandType.Text;
                strQuery.CommandText = "SELECT CATEGORYID,DESCRIPTION,ACTIVE FROM tblmcategory WHERE CATEGORYID LIKE @CategoryID AND DESCRIPTION LIKE @Description AND ACTIVE LIKE @Active ";
        ...
        public DataSet getData(string CategoryID, string Description)
        {
            ...
            try
            {
                ...
                strQuery.Connection = Conn.Conn;
                strQuery.CommandType = CommandType.Text;
                strQuery.CommandText = "SELECT CATEGORYID,DESCRIPTION,ACTIVE FROM tblmcategory WHERE CATEGORYID LIKE @CategoryID AND DESCRIPTION LIKE @Description  ";
                strQuery.Parameters.AddWithValue("@CategoryID", "%" + CategoryID + "%");
                strQuery.Parameters.AddWithValue("@Description", "%" + Description + "%");
                MySql.Data.MySqlClient.MySqlDataAdapter data = new MySql.Data.MySqlClient.MySqlDataAdapter(strQuery);
                data.Fill(ds, "tblmcategory");
        ...
        public bool insertData(mcategory k)
        {
            bool stat = false;
            try
            {
                ...
                strQuery.CommandText = "INSERT INTO tblmcategory VALUES(@CategoryID,@Description,@Active)";
        ...
        public bool updateData(string nip, mcategory k)
        {
            bool stat = false;
            try
            {
                ...
                strQuery.Connection = ConnG.Conn;
                strQuery.CommandType = CommandType.Text;
                strQuery.CommandText = "UPDATE tblmcategory SET DESCRIPTION=@Description,ACTIVE=@Active WHERE CATEGORYID=@CategoryID";
                strQuery.Parameters.AddWithValue("@Description", k.Description);
                strQuery.Parameters.AddWithValue("@Active", k.Active);
                //strQuery.Parameters.AddWithValue("@Type", k.Type);
                strQuery.Parameters.AddWithValue("@CategoryID", k.CategoryID);
        ...
        public bool deleteData(string costID)
        {
            ...
            try
            {
                ...
                strQuery.Connection = ConnG.Conn;
                strQuery.CommandType = CommandType.Text;
                strQuery.CommandText = "DELETE FROM tblmcategory WHERE CATEGORYID = @CategoryID";
