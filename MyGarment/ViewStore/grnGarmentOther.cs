...
{
    public partial class frmgrnOther : Form
    {
        ...
        private void grnOther_Load(object sender, EventArgs e)
        {
            ...
            else if (new grnCRUD().insertData(k))
            {
                ...
                for (int i = 0; i < dtGrid.Rows.Count - 1; i++)
                {
                   ...
                   // d.PONO = txtJONO.Text;
                    ...
                    d.SIZEID = Convert.ToString(dtGrid.Rows[i].Cells["hQtyPurchase"].Value);
